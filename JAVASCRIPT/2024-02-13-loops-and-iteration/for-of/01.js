...
for (let key of myObj1) {
    console.log(key); // obje iterable olmadığı için for of kullanılamaz. Prototipinde iterator olmayan objelerle kullanılamaz.
}
*/
...
console.log(entriesOfMyObj1);

for (let [key, value] of entriesOfMyObj1) {
